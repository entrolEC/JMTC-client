        ...
        <form action={dispatch}>
            <div className="mb-4">
                ...
                <div className="relative mt-2 rounded-md">
                    <Input id="code" name="code" placeholder="코드를 입력해주세요." defaultValue={item.code} aria-describedby="code-error" />
                </div>
            ...
            <div className="mb-4">
                ...
                <div className="relative mt-2 rounded-md">
                    <div className="relative">
                        <Input id="name" name="name" placeholder="이름을 입력하세요." defaultValue={item.name} aria-describedby="name-error" />
                    </div>
                </div>
